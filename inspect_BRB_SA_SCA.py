...
dfBRB = pd.read_csv('brb15.csv')
dfSA = pd.read_csv('sa15.csv')
dfSCA = pd.read_csv('sca15.csv')
...
axes[0].set_title("BRB - Distribuciones KDE")
...
axes[1].set_title("SA - Distribuciones KDE")
...
axes[2].set_title("SCA - Distribuciones KDE")
