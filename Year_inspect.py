...
df_all["year"] = df_all["year"].str.split("-").str[1].astype(float)
...
g.map_dataframe(sns.lineplot, x="year", y="rRMSE", hue="Model", marker="o")
g.set_axis_labels("Year", "rRMSE")
#g.set(ylim=(0, 90))
...
# ✅ Leyenda única, clara y horizontal
g.add_legend(
    loc="upper center",
    ncols=4,
    frameon=False
