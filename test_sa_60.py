...
data = pd.read_csv('/home/inenco/Documentos/Medidas/sa_15.csv')
data['datetime'] = pd.to_datetime(data.datetime)

data = (data.set_index('datetime')
      .reindex(pd.date_range(
    start="2009/01/01 00:00", end="2024/12/31 23:59", freq="15min"))
...
cams = pd.read_csv('/home/inenco/Documentos/HELIOSAT/sa.csv', usecols=['GHI'], sep=";", 
                   header=42)
...
lsasaf = pd.read_csv('/home/inenco/Documentos/LSASAF/sa_15.csv')
...
merra = (merra.set_index('datetime')
      .reindex(pd.date_range(
    start="2009/01/01 00:00", end="2024/12/31 23:59", freq="60min"))
      .rename_axis(['datetime'])
      .reset_index())
...
plt.plot(data.datetime, data.cams)
plt.plot(data.datetime, data.merra)
plt.show(block=False)
