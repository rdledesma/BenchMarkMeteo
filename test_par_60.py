...
data = pd.read_csv(f'/home/inenco/Documentos/Medidas/{str.lower(site.cod)}_60.csv')

data['datetime'] = pd.to_datetime(data.datetime)

data = (data.set_index('datetime')
      .reindex(pd.date_range(
    start="2019/01/01 00:00", end="2022/12/31 23:59", freq="60min"))
...
cams['datetime'] = pd.date_range(
    start="2019/01/01 00:00", end="2022/12/31 23:59", freq="15min"
)
...
lsasaf = pd.read_csv(f'/home/inenco/Documentos/LSASAF/{str.lower(site.cod)}_60.csv')
