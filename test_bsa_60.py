...
data = (data.set_index('datetime')
    ...
    start="2014/01/01 00:00", end="2023/12/31 23:59", freq="60min"))
...
cams['datetime'] = pd.date_range(
    start="2014/01/01 00:00", end="2023/12/31 23:59", freq="15min"
)
...
lsasaf = pd.read_csv('/home/inenco/Documentos/LSASAF/bsa_15.csv')
...
X = X[X.SZA<80]
X.describe()
X.to_csv('bsa60.csv', index=False)
