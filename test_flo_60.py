...
data = (data.set_index('datetime')
    ...
    start="2015/01/01 00:00", end="2022/12/31 23:59", freq="60min"))
...
cams = pd.read_csv('/home/inenco/Documentos/HELIOSAT/flo.csv', usecols=['GHI'], sep=";", 
                   header=42)
cams['datetime'] = pd.date_range(
    start="2015/01/01 00:00", end="2022/12/31 23:59", freq="15min"
)
...
lsasaf = pd.read_csv('/home/inenco/Documentos/LSASAF/flo_15.csv')
...
X.to_csv('flo60.csv', index=False)
